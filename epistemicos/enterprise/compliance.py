"""
EpistemicOS Enterprise Compliance Module (v2 Extension).
Provides GDPR/CCPA-compliant audit logging by decoupling off-chain PII storage
from immutable, cryptographically anchored ledger receipts.
"""
